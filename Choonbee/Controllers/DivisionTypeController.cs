...
namespace Choonbee.Controllers
{
    public class DivisionTypeController : Controller
    {
        ...
        {
            DivisionType divisiontype = db.DivisionTypes.Find(id);
        ...
        public ActionResult Create(DivisionType divisiontype)
        {
            ...
            {
                db.DivisionTypes.Add(divisiontype);
                db.SaveChanges();
        ...
        public ActionResult Edit(DivisionType divisiontype)
        {
            if (ModelState.IsValid)
            {
                db.Entry(divisiontype).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(divisiontype);
        ...
        {
            DivisionType divisiontype = db.DivisionTypes.Find(id);
            db.DivisionTypes.Remove(divisiontype);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
